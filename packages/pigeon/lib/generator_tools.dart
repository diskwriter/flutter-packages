...
String getGeneratedCodeWarning() {
  final String versionString = includeVersionInGeneratedWarning ? ' (v$pigeonVersion)' : '';
  //return 'Autogenerated from Pigeon$versionString, do not edit directly.';

  return 'DO NOT EDIT DIRECTLY!!! Autogenerated from a forked version of Pigeon $versionString.';
}

/// String to be printed after `getGeneratedCodeWarning()'s warning`.
const String seeAlsoWarning =
    'See also: https://github.com/diskwriter/flutter-packages/tree/feat/typescript-generator/packages/pigeon';
